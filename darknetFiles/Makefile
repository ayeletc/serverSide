...
main.o: src/main.cpp src/VideoProcess.h src/darknet.h src/geturl.h
	$(CC) -std=c++11 -c src/main.cpp

VideoProcess.o: src/VideoProcess.cpp src/VideoProcess.h
	$(CC) -std=c++11 -c src/VideoProcess.cpp

geturl.o: src/geturl.cpp src/geturl.h
	$(CC) -std=c++11 -c src/geturl.cpp

$(EXEC): $(OBJS) geturl.o VideoProcess.o main.o
